 ...
 * @author moi
 */
@WebServlet(name = "Add", urlPatterns = {"/Admin/Delete","/admin/Delete","/Admin/delete","/admin/delete"})
public class Delete extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            f.delFilm(Long.parseLong(request.getParameter("id")));
                out.println("<p>Film supprimé</p>");
